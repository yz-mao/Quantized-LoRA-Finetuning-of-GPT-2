...
class GPT2Attention(nn.Module):
    def __init__(self, config, is_cross_attention=False, layer_idx=None):
        ...
        if self.is_cross_attention:
            ...
            self.c_attn = lora.Quantized_MergedLinear(
        ...
        self.c_proj = lora.Quantized_Linear(self.embed_dim, self.embed_dim,
                                  r=config.lora_attn_dim,
                                  lora_alpha=config.lora_attn_alpha,
                                  lora_dropout=config.lora_dropout,
                                  fan_in_fan_out=True,
    ...
    def forward(
        ...
        if encoder_hidden_states is not None:
            ...
            self.c_attn.set_w_bits(self.w_bits)
        ...
        self.c_proj.set_w_bits(self.w_bits)
...
class GPT2MLP(nn.Module):
    def __init__(self, intermediate_size, config, layer_idx=None):
        ...
        self.c_fc = lora.Quantized_Linear(embed_dim, intermediate_size,
                                r=config.lora_attn_dim,
                                lora_alpha=config.lora_attn_alpha,
                                lora_dropout=config.lora_dropout,
                                fan_in_fan_out=True,
        ...
        self.c_proj = lora.Quantized_Linear(intermediate_size, embed_dim,
                                  r=config.lora_attn_dim,
                                  lora_alpha=config.lora_attn_alpha,
                                  lora_dropout=config.lora_dropout,
                                  fan_in_fan_out=True,
    ...
    def forward(self, hidden_states: Optional[Tuple[torch.FloatTensor]]) -> torch.FloatTensor:
        ...
        self.c_fc.set_w_bits(self.w_bits)
...
class GPT2Block(nn.Module):
    ...
    def forward(
        ...
        self.attn.set_w_bits(self.w_bits)
        ...
        self.mlp.set_w_bits(self.w_bits)
...
class GPT2ForQuestionAnswering(GPT2PreTrainedModel):
    def __init__(self, config):
        ...
        self.act_quantizer_k = SymQuantizer  # new
        self.act_quantizer_v = SymQuantizer  # new
        self.w_bits = config.num_bit_min
        #############################################################

        self.qa_outputs = lora.Quantized_Linear(
    ...
    def forward(
        ...
        self.transformer.set_w_bits(self.w_bits)
        ...
        self.qa_outputs.set_w_bits(self.w_bits)
